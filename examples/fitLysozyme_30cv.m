...
%==============================================================================
% Fit the 30 CV lysozyme peak curve
%==============================================================================
...
function res = objectiveFunc(params)
    ...
    try
        solution = createModelcolumnLysozyme(dataset(1:26400, 1), params, str);
    catch e
        res = 106800;
    ...
    res = [(solution(1:26400, 2) - dataset(1:26400, 2))];
    res = sum(res.^2);

    % Visualization if enabled
    if enablePlot
        figure(01); clf
        plot(dataset(10430:26400,1),  dataset(10430:26400,2), 'b:'); hold on
        plot(solution(10430:26400,1), solution(10430:26400,2), 'r'); hold off
        legend('Meas', 'Sim');
        grid on
    end
