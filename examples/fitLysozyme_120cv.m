...
%==============================================================================
% Fit the 120 CV lysozyme peak curve
%==============================================================================
...
function res = objectiveFunc(params)
    ...
    if enablePlot
        figure(01); clf
        plot(dataset(12400:38000,1),  dataset(12400:38000,2), 'b:'); hold on
        plot(solution(12400:38000,1), solution(12400:38000,2), 'r'); hold off
        legend('Meas', 'Sim');
        grid on
    end
