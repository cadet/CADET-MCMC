function fitAcetone_AIO
%==============================================================================
% Fit the single peak injection curves
% In the estimation of parameters due to the datasets (e.g., duplications) from
% one experiment, the effects of datasets are lumped together to determine
...
%------------------------------------------------------------------------------
    ...
    pf.addExperiment(data, sim, [0], idxComp, [], [], [], [], 'Acetone', {'007'});
...
%------------------------------------------------------------------------------
    ...
    % Add the experiment to the fit
    pf.addExperiment(data, sim, [0], idxComp, [], [], [], [], 'Acetone', {'006'});
...
%------------------------------------------------------------------------------
    ...
    % Add the experiment to the fit
    pf.addExperiment(data, sim, [0], idxComp, [], [], [], [], 'Acetone', {'005'});
