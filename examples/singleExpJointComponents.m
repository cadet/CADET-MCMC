function singleExpJointComponents()
%SINGLEEXPJOINTCOMPONENTS Fits adsorption rates in a single experiment with jointly observed components
%
...
%   artificial data. One experiment is performed and two wavelengths are measured.
%
%   The wavelengths capture a weighted sum of the components, where the weights are given
%   by the extinction coefficients. Since this example deals with artificial data, the
%   extinction coefficients are assumed to be all 1.
%
%   See also LOADWASHELUTIONSMASINGLE, PARAMETERIZEDSIMULATIONWITHSENSITIVITIES,
%      SINGLEEXPSEPARATECOMPONENTS
...
%            See the license note at the end of the file.
	...
	data{2} = sum(res.solution.outlet{1}(:, 2:end), 2);
	...
	idxComp{2} = [0 1 1 1]; % 280nm wavelength: Sum of all components (all factor 1)
	...
	pf.addExperiment(data, sim, [0 0], idxComp, [], [], [], [], 'Experiment1', {'528nm', '280nm'});
    ...
    opt.paramBound = [1 50; 0.1 10; 0.5 10];
