...
%==============================================================================
% Fit the 0 CV lysozyme peak curve
%==============================================================================
...
function res = objectiveFunc(params)
    ...
    try
        solution = createModelcolumnLysozyme(dataset(1:12650, 1), params, str);
    catch e
        res = 106800;
    ...
    res = [(solution(1:12650, 2) - dataset(1:12650, 2))];
    res = sum(res.^2);

    % Visualization if enabled
    if enablePlot
        figure(01); clf
        plot(dataset(8000:12650,1),  dataset(8000:12650,2), 'b:'); hold on
        plot(solution(8000:12650,1), solution(8000:12650,2), 'r'); hold off
        legend('Meas', 'Sim');
        grid on
    end
