...
%==============================================================================
% Fit the 5 CV lysozyme peak curve
%==============================================================================
...
function res = objectiveFunc(params)
    ...
    try
        solution = createModelcolumnLysozyme(dataset(1:14884, 1), params, str);
    catch e
        res = 106800;
    ...
    res = [(solution(1:14884, 2) - dataset(1:14884, 2))];
    res = sum(res.^2);

    % Visualization if enabled
    if enablePlot
        figure(01); clf
        plot(dataset(11000:14884,1),  dataset(11000:14884,2), 'b:'); hold on
        plot(solution(11000:14884,1), solution(11000:14884,2), 'r'); hold off
        legend('Meas', 'Sim');
        grid on
    end
