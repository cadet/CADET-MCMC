...
%==============================================================================
% Fit the 10 CV lysozyme peak curve
%==============================================================================
...
function res = objectiveFunc(params)
    ...
    try
        solution = createModelcolumnLysozyme(dataset(1:19250, 1), params, str);
    catch e
        res = 106800;
    ...
    res = [(solution(1:19250, 2) - dataset(1:19250, 2))];
    res = sum(res.^2);

    % Visualization if enabled
    if enablePlot
        figure(01); clf
        plot(dataset(13350:19250,1),  dataset(13350:19250,2), 'b:'); hold on
        plot(solution(13350:19250,1), solution(13350:19250,2), 'r'); hold off
        legend('Meas', 'Sim');
        grid on
    end
